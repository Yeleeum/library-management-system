...
--
-- Dumping data for table `bookdonations`
--

INSERT INTO `bookdonations` (`bdnid`, `donorname`, `title`, `author`, `publisher`, `thumbnail`, `description`, `category`, `keywords`, `edition`, `pageno`, `donationdate`, `approved`) VALUES
(1, '1', '2', '3', '2', 'myImage (2).png', '45', '45', '4', '5', 4, '2023-05-06', 'approved');
...
(1, 'test', 'I05', '2023-04-28', '2023-04-13', 'returned', 'approved'),
(2, 'koyel', 'I01', '2023-04-29', '2023-05-14', 'returned', 'approved'),
(3, 'test', 'I01', '2023-04-30', '2023-04-07', 'returned', 'approved'),
(4, 'user3', 'I01', '2023-05-01', '2023-05-16', 'returned', 'approved'),
(5, 'user3', 'I01', '2023-05-01', '2023-05-16', 'returned', 'approved'),
(6, 'user3', 'I02', '2023-05-02', '2023-05-17', 'notreturned', 'approved');
...
(1, 'koyel', 'S02', '2023-04-29'),
(2, 'user3', 'S02', '2023-05-02');
...
(1, 'test', '2023-04-28', '50', 'true'),
(3, 'test', '2023-04-30', '50', 'true'),
(4, 'test', '2023-04-30', '50', 'true');
...
--
-- Dumping data for table `journaldonations`
--

INSERT INTO `journaldonations` (`jdnid`, `donorname`, `title`, `publisher`, `editor`, `description`, `thumbnail`, `category`, `keywords`, `startyear`, `endyear`, `pageno`, `donationdate`, `approved`) VALUES
(1, 'Sinchan Nandy', 'Book', 'Chal na', '1', '2', 'myImage (2).png', '3', '3', 3, 3, 3, '2023-05-04', 'approved');
...
(5, 'I90', 'Research On Mars Planet', 'Earth Publishers', 'Sun ', 'A journal on the red planet', 'mars.png', 'astronomy', 'mars,astronomy,red planet', 2020, 2023, 45, 1);
...
--
-- Dumping data for table `magazinedonations`
--

INSERT INTO `magazinedonations` (`mdnid`, `title`, `donorname`, `publisher`, `issuedate`, `issuenumber`, `description`, `thumbnail`, `frequency`, `keywords`, `specialissue`, `category`, `donationdate`, `approved`) VALUES
(1, '2', '1', '3', '2023-05-04', '6', '7', 'myImage (2).png', '0', '9', '0', '8', '2023-05-04', 'approved'),
(2, '2', '1', '3', '2023-05-04', '6', '7', 'noor kata (1).png', '2', '9', '1', '8', '2023-05-04', 'approved');
...
(1, 'test', '2023-04-28', '300', 'null', 'approved', 'false', 'renewal'),
(2, 'test', '2023-04-28', '300', 'null', 'approved', 'false', 'renewal'),
(3, 'test', '2023-04-28', '50', 'null', 'approved', 'false', 'fine'),
(4, 'test', '2023-04-28', '300', 'null', 'rejected', 'false', 'renewal'),
(5, 'test', '2023-04-30', '50', '678', 'approved', 'true', 'fine'),
(6, 'test', '2023-04-30', '350', 'null', 'approved', 'false', 'renewal'),
(7, 'test', '2023-04-30', '300', 'null', 'rejected', 'false', 'renewal'),
(8, 'user3', '2023-05-01', '300', 'null', 'rejected', 'false', 'renewal'),
(9, 'user3', '2023-05-02', '300', 'null', 'approved', 'false', 'renewal');
...
(3, 'koyel', '1234', 'photo-1633332755192-727a05c4013d.jpeg', 'Koyeleema', 'Das', 'female', '2023-04-29', '07003512645', 'sinchannandy54@gmail.com', 'student', 'paid', 'abcd', 'approved'),
(4, 'user2', '$2a$10$QZBuHGXu/Q3jHQG5QUShCej5ms6kx05AzHO7gOy.k70EqrOn26gHG', 'myImage.png', 'Sinchan', 'Nandy', 'male', '2023-04-30', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'unpaid', '', 'approved'),
(5, 'user3', '$2a$10$WmU3su1OgH/4URcEBiZBnOhHGOl5aWYwyj9YGPF7hFViOdOEUlWq2', 'LMSTABLEUPDATED6.0.png', 'Sinchan', 'Nandy', 'male', '2023-04-30', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'unpaid', '', 'approved'),
(6, 'user4', '$2a$10$8ktqV3JCWGDnbF/YDY9VCupqbtatz3mHXEvJnsYtTahLdMdPtEnaW', 'myImage.png', 'Sinchan', 'Nandy', 'male', '2023-05-02', '07003512645', 'supriyosarkarcome@gmail.com', 'regular', 'paid', '67890567', 'rejected'),
(7, 'user', '$2a$10$f4XdbHW1nd1IqOlQaULzSOwlC24Sm7Z3SwTMet3NTtzc8bXER05he', '273459962_1636113900055442_7228868579176044961_n.jpg', 'Sinchan', 'Nandy', 'male', '2002-03-27', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'unpaid', '', 'approved');
...
--
-- Dumping data for table `softcopydonations`
--

INSERT INTO `softcopydonations` (`sdnid`, `donorname`, `title`, `owner`, `publisher`, `description`, `thumbnail`, `category`, `keywords`, `pageno`, `filename`, `donationdate`, `approved`) VALUES
(3, '1', '2', '3', '4', '5', 'myImage (1).png', '6', '7', 8, 'Your e-Admit Card (1).pdf', '2023-05-04', 'approved'),
(4, '1', '2', '3', '4', '5', '273459962_1636113900055442_7228868579176044961_n.jpg', '6', '7', 8, 'Your e-Admit Card (2).pdf', '2023-05-05', 'approved');
...
--
-- Dumping data for table `thesesdonations`
--

INSERT INTO `thesesdonations` (`TDNID`, `DONORNAME`, `TITLE`, `RESEARCHER`, `GUIDES`, `DESCRIPTION`, `THUMBNAIL`, `CATEGORY`, `KEYWORDS`, `COMPLETEDDATE`, `PLACE`, `ABSTRACT`, `PAGENO`, `DONATIONDATE`, `APPROVED`) VALUES
(1, '1', '2', '3', '4', '5', '273459962_1636113900055442_7228868579176044961_n.jpg', '6', '7', '2023-05-05', '9', '0', 11, '2023-05-05', 'approved');
...
('koyel', '1234', 'photo-1633332755192-727a05c4013d.jpeg', 'Koyeleema', 'Das', 'female', '2023-04-29', '07003512645', 'sinchannandy54@gmail.com', 'student', 'active', '2024-04-29'),
('test', 'test', 'admin.png', 'test', 'test', 'other', '2023-04-05', '7291874372', 'hiayushsingh.co.in@gmail.com', 'student', 'active', '2028-04-27'),
('user', '$2a$10$f4XdbHW1nd1IqOlQaULzSOwlC24Sm7Z3SwTMet3NTtzc8bXER05he', '273459962_1636113900055442_7228868579176044961_n.jpg', 'Sinchan', 'Nandy', 'male', '2002-03-27', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'active', '2024-05-02'),
('user2', '$2a$10$QZBuHGXu/Q3jHQG5QUShCej5ms6kx05AzHO7gOy.k70EqrOn26gHG', 'myImage.png', 'Sinchan', 'Nandy', 'male', '2023-04-30', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'active', '2024-04-30'),
('user3', '$2a$10$WmU3su1OgH/4URcEBiZBnOhHGOl5aWYwyj9YGPF7hFViOdOEUlWq2', 'LMSTABLEUPDATED6.0.png', 'Sinchan', 'Nandy', 'male', '2023-04-30', '07003512645', 'sinchannandy54@gmail.com', 'regular', 'active', '2025-04-30');
...
--
ALTER TABLE `bookdonations`
  MODIFY `bdnid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `journaldonations`
  MODIFY `jdnid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `magazinedonations`
  MODIFY `mdnid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `registration`
  MODIFY `RSID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `softcopydonations`
--
ALTER TABLE `softcopydonations`
  MODIFY `sdnid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `thesesdonations`
  MODIFY `TDNID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
