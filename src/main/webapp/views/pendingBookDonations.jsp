        ...
        <div class="registrations">
            <form class="registrations-inner-wrapper">
                ...
                <% if( !(bookDonations == null || bookDonations.isEmpty()) ) { %>
                    ...
                    <td><button formaction="/admin/rejectDonatedBooks/<%= bookDonation.getBdnid() %>" formmethod="get" style="background-color: #e31747; color: white; border-radius: 10px; padding: 8px 10px; border: none; font-weight: bolder;cursor: pointer;">Reject</button></td>
                </tr>
                <%}%>
                <% } else { %>
