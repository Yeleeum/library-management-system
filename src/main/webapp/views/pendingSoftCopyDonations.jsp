...
<%
    ...
    List<SoftCopyDonations> softCopyDonations=(List<SoftCopyDonations>)request.getAttribute("softCopyDonations");
%>
<body>
    <div class="container">
            ...
            <main>
                <div class="breadCrumbs">
                    <p>
                        ...
                        <span>Dashboard</span>
                        <i class="fa-solid fa-angle-right"></i>
                        <span>Pending Donated SoftCopy Requests</span>
                    </p>
                </div>
        <div class="registrations">
            <form class="registrations-inner-wrapper">
                <h1>Pending SoftCopy Donations</h1>
                ...
                <% if( !(softCopyDonations == null || softCopyDonations.isEmpty()) ) { %>
                    <%for(SoftCopyDonations softCopyDonation:softCopyDonations){%>
                    <tr>
                    <td><%=softCopyDonation.getSdnid()%></td>
                    <td><%=softCopyDonation.getDonorName()%></td>
                    <td><%=softCopyDonation.getTitle()%></td>
                    <td><%=softCopyDonation.getPublisher()%></td>
                    <td><%=softCopyDonation.getOwner()%></td>
